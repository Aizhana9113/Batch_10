...
*/
        ...
        System.out.println("Please enter your first test score betveen 0 to 100 ");
        ...
        if (average >= 90 && average <= 100) {
            ...
            System.out.println("print 'Your average test score is <average> and letter grade is C");
        } else if (average >= 60 && average < 70) {
            System.out.println("print 'Your average test score is <average> and letter grade is D");


        }else{
            System.out.println("You need this course again! ");
        }
    }
}
